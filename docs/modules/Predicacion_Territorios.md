# Congre-Admin: Plug-in de Territorios
...
- **Reportes:**
    -   `{ "id": "S-13-S", "nombre": "Registro de Asignación de Territorio", "tipo": "pdf_overlay", "template": "./assets/templates/S-13_S.pdf" }`

## 2. Estructura de Datos (Esquema)

Para la inicialización automática (`initSheet`), se deben usar estas cabeceras exactas:

### Tabla: `Territorios_Maestro`
- `id`, `nombre`, `grupoId`, `tipo`, `limites`, `manzanas`, `ultimaDevolucion`, `enc_observaciones`

### Tabla: `Territorios_Asignaciones`
- `id`, `territorioId`, `personaId`, `fechaAsignacion`, `fechaDevolucion`, `resultado`, `enc_comentario`

### Tabla: `Mapa_Poligonos`
- `id`, `type`, `geometry`, `properties` (Almacenado como JSON)

### Tabla: `Mapa_Puntos`
- `id`, `nombre`, `type`, `geometry`, `properties`

### Tabla: `Grupos_Predicacion`
- `id`, `nombre`, `color`, `responsableId`

---

### Detalles de Objetos (Ejemplos JSON)
~~~json
{
    "id": "22",
    "nombre": "Barrio Norte",
