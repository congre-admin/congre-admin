# Congre-Admin: Gestión de Mapas y Territorios
...
-   Organizada en **Pestañas**:
    1.  `Territorios`: Control de inventario y asignaciones (ver [Asignaciones](./Predicacion_Asignaciones.md)).
    2.  `Mapas`: Editor de polígonos GeoJSON y límites.
    3.  `Puntos de Encuentro`: Gestión de ubicaciones para el programa de casa en casa.        -   **Permisos:** 
        ...
        El sistema cruza el mapa con el [Sistema de Asignaciones](./Predicacion_Asignaciones.md) para generar el **Mapa de Calor** automático basado en antigüedad.
