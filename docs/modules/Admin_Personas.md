...
Se basa estrictamente en la especificación de la [Base de Datos de Personas](./Personas.md).
...
-   **Indicadores visuales:** Iconos de candado en campos cifrados AES-GCM.
