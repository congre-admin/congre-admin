  ...
  const handleStartSetup = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Error al crear credencial. Asegúrate de usar un navegador compatible con WebAuthn.');
      }
      ...
      >
        <Paper sx={{ p: 4, maxWidth: 400, width: '100%', textAlign: 'center' }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Ahora puedes usar tu dispositivo para iniciar sesión de forma segura.
          </Typography>
        ...
        {step === 0 && (
          <Box>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Un passkey te permite iniciar sesión usando tu dispositivo (huella digital, rostro, PIN, etc.) 
            ...
            <List sx={{ mb: 2 }}>
              <ListItem>
                ...
                <ListItemText 
                  primary="Compatible con múltiples dispositivos" 
